...
//---------------------------------------------------------------------------
stricherRenderManager::stricherRenderManager(){
...
//---------------------------------------------------------------------------
void stricherRenderManager::allocateForNScreens(int numScreens, int renderWidth, int renderHeight){
    if( numScreens < 1){
        printf("stricherRenderManager::allocateForNScreens - you need at lease one screen!\n");
        return;
    }
    width   = renderWidth;
    height  = renderHeight;
...
//---------------------------------------------------------------------------
void stricherRenderManager::startOffscreenDraw(){
...
//---------------------------------------------------------------------------
void stricherRenderManager::endOffscreenDraw(){
    if( nScreens <= 0 ) return;
...
//---------------------------------------------------------------------------
void stricherRenderManager::drawInputDiagnostically(float x, float y, float w, float h){
   if( nScreens <= 0 ) return;
...
//---------------------------------------------------------------------------
void stricherRenderManager::drawOutputDiagnostically(float x, float y, float w, float h){
    if( nScreens <= 0 ) return;
...
//---------------------------------------------------------------------------
void stricherRenderManager::drawScreen(int nScreen){
    if( nScreens <= 0 ) return;
...
//---------------------------------------------------------------------------
void stricherRenderManager::resetCoordinates(){
    if( nScreens <= 0)return;
...
//---------------------------------------------------------------------------
void stricherRenderManager::loadFromXml(string xmlFileName){
    xmlFile = xmlFileName;
...
//---------------------------------------------------------------------------
void stricherRenderManager::reloadFromXml(){
    if(xmlFile == "")return;
...
//---------------------------------------------------------------------------
void stricherRenderManager::saveToXml(){
    if(xmlFile != ""){
        saveToXml(xmlFile);
    }
}
...
void stricherRenderManager::saveToXml(string xmlFileName){
...
//---------------------------------------------------------------------------
bool stricherRenderManager::mouseSelectInputPoint(ofRectangle drawRect, ofPoint mousePoint, float clickRadius){
...
//---------------------------------------------------------------------------
bool stricherRenderManager::mouseDragInputPoint(ofRectangle drawRect, ofPoint mousePoint){
    if( nScreens <= 0 ) return false;
...
//---------------------------------------------------------------------------
bool stricherRenderManager::mouseSelectOutputPoint(ofRectangle drawRect, ofPoint mousePoint, float clickRadius){
    if( nScreens <= 0 ) return false;
...
//---------------------------------------------------------------------------
bool stricherRenderManager::mouseDragOutputPoint(ofRectangle drawRect, ofPoint mousePoint){
    if( nScreens <= 0 ) return false;
