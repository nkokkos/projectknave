...
#define OF_QT_SAVER_CODEC_SORENSON_3 2
#define OF_QT_SAVER_CODEC_H264 4
#define OF_QT_SAVER_CODEC_NONE 18
#define OF_QT_SAVER_CODEC_ANIMATION 18
#define OF_QT_SAVER_CODEC_GRAPHICS 20
